...
<template>
  <div class="card">
    ...
    <div class="status">
      ...
      <div class="buttons">
        <button :class="{ 'active': isCollected }" @click="toggleCollection">
          典
        </button>
        <button :class="{ 'active': isDynamic }" @click="toggleDynamic">
          動
        </button>
      </div>
    </div>
    ...
    <div class="card-info">
      ...
      <div class="stars">
        <span v-for="index in 5" :key="index" :class="{ 'active': index <= rating }"
      ...
      <div class="select-item">
        ...
        <button class="clear-button" @click="selectedOption1=''"><i class="fas fa-times"></i></button>
      </div>
      <div class="select-item">
        ...
        <button class="clear-button" @click="selectedOption2=''"><i class="fas fa-times"></i></button>
      </div>
      <div class="select-item">
        ...
        <button class="clear-button" @click="selectedOption3=''"><i class="fas fa-times"></i></button>
      </div>
      <div class="type-status">
        <button class="main-button" @click="openSelection()">
          <span>{{ selectedOption4 }}</span>
        </button>
        <button :class="{ 'active': selectedOption5 === 'C' }" class="cbas-button" @click="selectedOption5='C'">C
        </button>
        <button :class="{ 'active': selectedOption5 === 'B' }" class="cbas-button" @click="selectedOption5='B'">B
        </button>
        <button :class="{ 'active': selectedOption5 === 'A' }" class="cbas-button" @click="selectedOption5='A'">A
        </button>
        <button :class="{ 'active': selectedOption5 === 'S' }" class="cbas-button" @click="selectedOption5='S'">S
        </button>
      </div>
    </div>
  </div>
